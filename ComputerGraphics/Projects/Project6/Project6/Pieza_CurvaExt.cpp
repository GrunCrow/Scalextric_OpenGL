...
Pieza_CurvaExt::Pieza_CurvaExt(CGMaterial* mtl, GLfloat p, GLfloat m, GLfloat r0, GLfloat r1, GLfloat &vx1, GLfloat &vx2, GLfloat &vz1, GLfloat &vz2)
{
	...
	GLfloat x = r1*sin(M_PI / 40);
	GLfloat z = r1*(1 - cos(M_PI / 40));
